from apps.webshop.communication.managers import CommunicationTypeManager
...
class CommunicationEventType(models.Model):
    ...
    # File templates
    email_subject_template_file = "webshop/communication/emails/commtype_%s_subject.txt"
    email_body_template_file = "webshop/communication/emails/commtype_%s_body.txt"
    email_body_html_template_file = "webshop/communication/emails/commtype_%s_body.html"
    sms_template_file = "webshop/communication/sms/commtype_%s_body.txt"
    ...
    def get_messages(self, ctx=None):
        ...
        if ctx is None:
            ctx = {}
        ctx["static_base_url"] = getattr(settings, "STATIC_BASE_URL", None)
