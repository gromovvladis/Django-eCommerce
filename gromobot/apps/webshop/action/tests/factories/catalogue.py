...
class ProductFactory(factory.django.DjangoModelFactory):
    ...
    stockrecords = factory.RelatedFactory(
        "apps.webshop.test.factories.StockRecordFactory", "product"
    )
    categories = factory.RelatedFactory(
        "apps.webshop.test.factories.ProductCategoryFactory", "product"
    )
...
class ProductReviewFactory(factory.django.DjangoModelFactory):
    ...
    class Meta:
        model = get_model("product_reviews", "ProductReview")
