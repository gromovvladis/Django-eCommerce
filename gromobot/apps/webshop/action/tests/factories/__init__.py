...
from apps.webshop.action.tests.factories.address import *
from apps.webshop.action.tests.factories.basket import *
from apps.webshop.action.tests.factories.catalogue import *
from apps.webshop.action.tests.factories.contrib import *
from apps.webshop.action.tests.factories.customer import *
from apps.webshop.action.tests.factories.models import *
from apps.webshop.action.tests.factories.offer import *
from apps.webshop.action.tests.factories.order import *
from apps.webshop.action.tests.factories.partner import *
from apps.webshop.action.tests.factories.payment import *
from apps.webshop.action.tests.factories.voucher import *
from apps.webshop.action.tests.factories.wishlists import *

Basket = get_model("basket", "Basket")
Free = get_class("webshop.shipping.methods", "Free")
...
PurchaseInfo = get_class("webshop.partner.strategy", "PurchaseInfo")
Default = get_class("webshop.partner.strategy", "Default")
StockRequired = get_class("webshop.partner.availability", "StockRequired")
FixedPrice = get_class("webshop.partner.prices", "FixedPrice")
