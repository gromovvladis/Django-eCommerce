...
OSCAR_ORDER_STATUS_PIPELINE = {
    'Обрабатывается': ('Готовится', 'Оплачен', 'Завершён', 'Отменен'),

    'Ожидает оплаты': ('Оплачен', 'Обрабатывается', 'Завершён', 'Отменен'),
    'Оплачен': ('Готовится', 'Завершён', 'Отменен'),

    'Готовится': ('Готов', 'Завершён', 'Отменен'),
