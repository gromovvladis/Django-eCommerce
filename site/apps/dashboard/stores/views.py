...
from django.views.generic import CreateView, DeleteView, UpdateView, View, DetailView
from django_tables2 import SingleTableView
from apps.dashboard.users.views import CustomerListView
...
class StoreCreateView(CreateView):
    model = Store
    template_name = "dashboard/stores/store_form.html"
...
class StoreManageView(UpdateView):
    ...
    model = Store
    template_name = "dashboard/stores/store_manage.html"
    form_class = StoreForm
    success_url = reverse_lazy("dashboard:store-list")
...
class StoreCashTransactionListView(SingleTableView):
    ...
    template_name = "dashboard/stores/store_cash_transaction_list.html"
...
class StoreCashTransactionCreateView(CreateView):
    ...
    template_name = "dashboard/stores/store_cash_transaction_create.html"
...
class TerminalListView(SingleTableView):
    ...
    template_name = "dashboard/stores/terminal_list.html"
...
class TerminalDetailView(DetailView):
    ...
    model = Terminal
    template_name = "dashboard/stores/terminal_detail.html"
...
class StaffListView(CustomerListView):
    ...
    template_name = "dashboard/stores/staff_list.html"
...
class StaffDetailView(UpdateView):
    ...
    template_name = "dashboard/stores/staff_detail.html"
...
class StaffCreateView(CreateView):
    model = Staff
    form_class = StaffForm
    template_name = "dashboard/stores/staff_create.html"
    success_url = reverse_lazy("dashboard:staff-list")
...
class StaffDeleteView(DeleteView):
    model = Staff
    template_name = "dashboard/stores/staff_delete.html"
...
class StoreStaffSelectView(StaffListView):
    template_name = "dashboard/stores/store_user_select.html"
    ...
    def post(self, request, user_pk, store_pk):
        ...
        if self.unlink_user(user, store):
            msg = render_to_string(
                "dashboard/stores/messages/user_unlinked.html",
                {
                    "user_name": name,
...
class GroupListView(SingleTableView):
    ...
    template_name = "dashboard/stores/group_list.html"
...
class GroupDetailView(UpdateView):
    ...
    template_name = "dashboard/stores/group_detail.html"
...
class GroupCreateView(CreateView):
    model = Group
    form_class = GroupForm
    template_name = "dashboard/stores/group_create.html"
    success_url = reverse_lazy("dashboard:group-list")
...
class GroupDeleteView(DeleteView):
    model = Group
    template_name = "dashboard/stores/group_delete.html"
