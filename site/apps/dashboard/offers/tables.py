...
class ConditionalOfferTable(DashboardTable):
    image = TemplateColumn(
        verbose_name="",
        template_name="dashboard/offers/offer_row_image.html",
        orderable=False,
    )
    name = LinkColumn(
    ...
    restrictions = TemplateColumn(
        ...
        template_name="dashboard/offers/offer_row_restrictions.html",
    ...
    total_discount = TemplateColumn(
        ...
        template_name="dashboard/offers/offer_row_total_discount.html",
        order_by=("total_discount"),
    )
    actions = TemplateColumn(
        verbose_name="",
        template_name="dashboard/offers/offer_row_actions.html",
        orderable=False,
        attrs={
            "th": {"class": "actions"},
        },
