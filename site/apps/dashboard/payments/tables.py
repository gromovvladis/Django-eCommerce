...
class PaymentListTable(DashboardTable):
    ...
    order = TemplateColumn(
        verbose_name="Заказ",
        template_name="dashboard/payments/transaction_row_order.html",
    ...
    status = TemplateColumn(
        verbose_name="Статус",
        template_name="dashboard/payments/transaction_row_status.html",
        accessor=A("status"),
        order_by="status",
        attrs={
            "th": {"class": "status"},
    ...
    amount = TemplateColumn(
        verbose_name="Сумма",
        template_name="dashboard/payments/transaction_row_amount.html",
        accessor=A("amount"),
    ...
    created_at = TemplateColumn(
        ...
        template_name="dashboard/payments/transaction_row_created_at.html",
    ...
    actions = TemplateColumn(
        verbose_name="",
        template_name="dashboard/payments/payment_row_actions.html",
        orderable=False,
        attrs={
            "th": {"class": "actions"},
        },
...
class RefundListTable(DashboardTable):
    ...
    cancellation_details = TemplateColumn(
        ...
        template_name="dashboard/payments/refund_row_cancellation_details.html",
    ...
    actions = TemplateColumn(
        verbose_name="",
        template_name="dashboard/payments/refund_row_actions.html",
        orderable=False,
        attrs={
            "th": {"class": "actions"},
        },
