...
class ReviewOrderTable(DashboardTable):
    checkbox = TemplateColumn(
        verbose_name="",
        template_name="dashboard/reviews/review_row_checkbox.html",
        orderable=False,
        attrs={
            "th": {"class": "checkbox"},
        },
    ...
    name = TemplateColumn(
        verbose_name="Заказ",
        template_name="dashboard/reviews/review_row_order.html",
        order_by="order",
    )
    user = Column(
    ...
    score = TemplateColumn(
        verbose_name="Оценка",
        template_name="dashboard/reviews/review_row_score.html",
        orderable=True,
    )
    body = TemplateColumn(
        verbose_name="Отзыв",
        template_name="dashboard/reviews/review_row_body.html",
        orderable=True,
    )
    status = TemplateColumn(
        verbose_name="Статус",
        template_name="dashboard/reviews/review_row_status.html",
        order_by="status",
    )
    date_created = TemplateColumn(
        verbose_name="Дата создания",
        template_name="dashboard/reviews/review_row_date.html",
        orderable=True,
    )
    actions = TemplateColumn(
        verbose_name="",
        template_name="dashboard/reviews/review_row_order_action.html",
        orderable=False,
        attrs={
            "th": {"class": "actions"},
        },
...
class ReviewProductTable(DashboardTable):
    ...
    name = TemplateColumn(
        verbose_name="Товар",
        template_name="dashboard/reviews/review_row_product.html",
        order_by="product",
    )
    user = Column(
        verbose_name="Пользователь",
    ...
    actions = TemplateColumn(
        verbose_name="",
        template_name="dashboard/reviews/review_row_product_action.html",
        orderable=False,
        attrs={
            "th": {"class": "actions"},
        },
