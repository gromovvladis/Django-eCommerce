...
# ActionTable = get_class("dashboard.action.tables", "ActionTable")
# PromoCategoryTable = get_class("dashboard.action.tables", "PromoCategoryTable")
# ActionForm, PromoCategoryForm = get_classes(
#     "dashboard.action.forms", ["ActionForm", "PromoCategoryForm"]
# )
...
# class ActionListView(SingleTableView):
...
# class ActionProductListView(BulkEditMixin, ListView):
#     model = Product
