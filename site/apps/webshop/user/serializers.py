...
UserGroupEvotor = get_model("evotor", "UserGroupEvotor")
...
class UserGroupSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if evotor_data:
            UserGroupEvotor.objects.create(group=group, evotor_id=evotor_data)
    ...
    def update(self, instance, validated_data):
        ...
        if evotor_data:
            ...
            try:
                group_evotor = UserGroupEvotor.objects.get(group=instance)
                group_evotor.evotor_id = evotor_data  # Обновляем evotor_id
                group_evotor.save()
            except UserGroupEvotor.DoesNotExist:
                # Если записи UserGroupEvotor нет, создаем её
                UserGroupEvotor.objects.create(group=instance, evotor_id=evotor_data)
...
class StaffSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if role_data:
            ...
            group_evotor, _ = UserGroupEvotor.objects.get_or_create(group=group)
