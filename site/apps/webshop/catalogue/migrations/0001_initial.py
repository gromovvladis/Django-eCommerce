    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    core.models.fields.autoslugfield.AutoSlugField(
                        ...
                        blank=True,
                        editable=False,
                        help_text="Универсальный код товара (Артикул) является идентификатором для товара, который является специфичным для конкретного товара. Оставьте пустым, чтобы заполнить автоматически.",
                        max_length=64,
                        overwrite=True,
                        populate_from="name",
                        unique=True,
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        max_length=255,
                        null=True,
                        upload_to=core.models.img.paths.get_image_additionals_upload_path,
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=core.models.img.paths.get_image_categories_upload_path,
                        verbose_name="Изображение",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        max_length=255,
                        null=True,
                        upload_to=core.models.img.paths.get_image_products_upload_path,
                    ),
                ),
                (
                    "value_image",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    core.models.fields.NullCharField(
