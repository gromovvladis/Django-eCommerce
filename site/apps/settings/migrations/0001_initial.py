    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subdomain",
                    models.CharField(max_length=255, verbose_name="Поддомен клиента"),
                ),
                (
                    "auth",
                    models.CharField(
                        choices=[
                            ("apps.user.auth_backends.PhoneBackend", "Телефон"),
                            (
                                "apps.user.auth_backends.PhoneBackend",
                                "Электронная почта",
                            ),
                        ],
                        default="apps.user.auth_backends.PhoneBackend",
                        max_length=255,
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            (1, "Упрощенная (УСН, доходы)"),
                            (2, "Упрощенная (УСН, доходы минус расходы)"),
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Несколько магазинов",
                    ),
                ),
                (
                    "support_link",
                ...
                (
                    "analytics_google",
                    models.CharField(
                        max_length=255, null=True, verbose_name="ID Google аналитики"
                    ),
                ),
                (
                    "analytics_yandex",
