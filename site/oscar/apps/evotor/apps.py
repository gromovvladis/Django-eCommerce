...
class EvotorConfig(OscarConfig):
    ...
    def ready(self):
        ...
        self.evotor_api_store_view = get_class("evotor.views", "EvotorStoreEndpointView")
        self.evotor_api_staff_view = get_class("evotor.views", "EvotorStaffEndpointView")
        ...
        self.evotor_api_terminal_view = get_class("evotor.views", "EvotorTerminalEndpointView")
        self.evotor_api_product_view = get_class("evotor.views", "EvotorProductEndpointView")
        self.evotor_api_installation_view = get_class(
            "evotor.views", "EvotorInstallationEndpointView"
        )

        self.evotor_api_user_login_view = get_class("evotor.views", "EvotorLoginEndpointView")

    def get_urls(self):
        urls = super().get_urls()
        urls += [
            path("api/stores/", self.evotor_api_store_view.as_view(), name="api-stores"),
            path("api/staffs/", self.evotor_api_staff_view.as_view(), name="api-staffs"),
