...
from oscar.apps.dashboard.evotor.mixins import EvotorTablesMixin
...
class EvotorStoreListView(EvotorTablesMixin):
    template_name = "oscar/dashboard/evotor/stores/store_list.html"
    model = Store
...
class EvotorTerminalListView(EvotorTablesMixin):
    template_name = "oscar/dashboard/evotor/terminals/terminal_list.html"
    model = Terminal
...
class EvotorStaffListView(EvotorTablesMixin):
    template_name = "oscar/dashboard/evotor/staffs/staff_list.html"
    model = Staff
...
class EvotorGroupsListView(EvotorTablesMixin):
    template_name = "oscar/dashboard/evotor/groups/group_list.html"
    model = Category
...
class EvotorProductListView(EvotorTablesMixin):
    template_name = "oscar/dashboard/evotor/products/product_list.html"
    model = Product
    form_class = EvotorStoreForm
...
class EvotorAdditionalListView(EvotorTablesMixin):
    template_name = "oscar/dashboard/evotor/additionals/additional_list.html"
    model = Additional
    form_class = EvotorStoreForm
...
class EvotorDocsListView(SingleTableView):
    template_name = "oscar/dashboard/evotor/docs/doc_list.html"
