...
class PaymentsListView(TransactionsListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['status_options'] = [('succeeded', 'Платеж успешно завершён'), ('canceled', 'Платеж отменен'), ('pending', 'Платеж создан и ожидает оплаты от пользователя'), ('waiting_for_capture', 'Платеж оплачен, деньги авторизованы и ожидают списания')]
        return context
