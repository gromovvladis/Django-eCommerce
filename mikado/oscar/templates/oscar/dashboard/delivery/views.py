...
DeliveryZona = get_model("address", "DeliveryZona")
...
class DeliveryZonesUpdateView(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ctx = super().get_context_data(**kwargs)
        ctx["title"] = "Обновить зону дсоатвки '%s'" % self.object.number
        return ctx
...
class PopUpDeliveryZonesUpdateView(UpdateView):
    form_class = DeliveryZonaForm
...
class PopUpDeliveryZonesView(CreateView):
    form_class = DeliveryZonaForm
    def get(self):
        pass
