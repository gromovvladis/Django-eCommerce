        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "error_message",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Error Message"
                    ),
                ),
                (
                    "date_processed",
                    models.DateTimeField(null=True, verbose_name="Date Processed"),
                ),
                (
                    "num_new_skus",
                    models.PositiveIntegerField(
                        null=True, verbose_name="Number of New SKUs"
                    ),
                ),
                (
                    "num_unknown_skus",
                    models.PositiveIntegerField(
                        null=True, verbose_name="Number of Unknown SKUs"
                    ),
                ),
                (
                    "num_duplicate_skus",
                    models.PositiveIntegerField(
                        null=True, verbose_name="Number of Duplicate SKUs"
                    ),
                ),
                (
                    "range",
