...
#         if self.object.user:
#             msg = "Оповещение создано"
#         else:
#             msg = "Письмо с подтверждением было отправлено на адрес %s" % self.object.email
...
#             self.alert.confirm()
#             messages.success(self.request, "Ваше оповещение об акциях теперь активно")
#         else:
#             messages.error(self.request, "Ваше оповещение о наличии товара не может быть подтверждено")
...
#             self.alert.cancel()
#             messages.success(self.request, "Ваше оповещение о наличии акций было отменено")
#         else:
#             messages.error(self.request, "Ваше оповещение о наличии акций не может быть отменено")
