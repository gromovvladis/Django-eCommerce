        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key",
                    models.CharField(
                        blank=True, db_index=True, max_length=128, verbose_name="Key"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "date_confirmed",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Date confirmed"
                    ),
                ),
                (
                    "date_cancelled",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Date cancelled"
                    ),
                ),
                (
                    "date_closed",
