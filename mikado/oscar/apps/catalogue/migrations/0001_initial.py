...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "upc",
                    oscar.models.fields.NullCharField(
                        help_text="Универсальный код продукта (UPC) является идентификатором для продукта, который не является специфичным для конкретного товара. Например, ISBN книги",
                        max_length=64,
                        unique=True,
                ...
                (
                    "cooking_time",
                    models.IntegerField(default=20, verbose_name="Время приготовления"),
                ),
                (
                    "date_created",
                    models.DateTimeField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text="Дополнительные товары для данного продукта",
                through="catalogue.ProductAdditional",
                to="catalogue.additional",
