        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "upc",
                    oscar.models.fields.NullCharField(
                        help_text="Универсальный код товара (Артикул) является идентификатором для товара, который не является специфичным для конкретного товара. Например, ISBN книги",
                        max_length=64,
                        unique=True,
                        verbose_name="Товарный код товара UPC (Артикул)",
                    ),
                ),
                (
                    "title",
