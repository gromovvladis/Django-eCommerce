...
# BaseStockRecordStockAndPriceFormSet = inlineformset_factory(
#     Product, StockRecord, form=StockRecordStockAndPriceForm, extra=1
# )


# class StockRecordStockAndPriceFormSet(BaseStockRecordStockAndPriceFormSet):
    # def __init__(self, product_class, user, *args, **kwargs):
    #     self.user = user
    #     self.require_user_stockrecord = not user.is_staff
    #     self.product_class = product_class
