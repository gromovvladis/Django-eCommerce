...
ShippingAddressForm, ShippingMethodForm, GatewayForm, CheckoutForm = get_classes(
    "checkout.forms", ["ShippingAddressForm", "ShippingMethodForm", "GatewayForm", "CheckoutForm"]
)
