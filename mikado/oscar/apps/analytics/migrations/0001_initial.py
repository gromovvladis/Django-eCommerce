        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "num_purchases",
                    models.PositiveIntegerField(
                        db_index=True, default=0, verbose_name="Purchases"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "num_orders",
                    models.PositiveIntegerField(
                        db_index=True, default=0, verbose_name="Orders"
                    ),
                ),
                (
                    "num_order_lines",
                    models.PositiveIntegerField(
                        db_index=True, default=0, verbose_name="Order Lines"
                    ),
                ),
                (
                    "num_order_items",
                    models.PositiveIntegerField(
                        db_index=True, default=0, verbose_name="Order Items"
                    ),
                ),
                (
                    "total_spent",
