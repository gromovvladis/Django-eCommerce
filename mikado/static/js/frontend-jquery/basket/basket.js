...
var basket_saved = $(cartWrapper).find('[data-id="saved-formset"]');
...
if ($(basket_saved).length > 0){
    var forms = $(basket_saved).find('[data-id="cart-item-form"]');
    $(forms).each(function(){
        var form_item = $(this)
        var delete_item = $(form_item).find('[data-id="cart-item-delete"]');
